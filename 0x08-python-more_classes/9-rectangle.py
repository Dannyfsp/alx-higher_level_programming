...
Uses Static method that returns the biggest rectangle based on the area
Class method that returns a new Rectangle instance with width equals
height equals size
"""
...
class Rectangle:
    ...
    def square(cls, size=0):
        """Returns a new Rectangle instance with width equals height"""
